# -*- coding: utf-8 -*-
"""
Created on Sun Oct 22 20:07:16 2017
...
data=[("I love this Laptop","Positive"),("The dish tastes amazing","Positive"),
...
def preprocessing(original_tweet):
    ...
    #print(result6)
    corr_tweet=" ".join(result6)
    return corr_tweet

tweets=[]
for cols in data:
    preprocessed_sentence=preprocessing(cols[0])
